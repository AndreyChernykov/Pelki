...
{
    public class SavesStorage : IDisposable, ISaverData
    {
        ...
        {
            _loadSaveData = LoadingSaveData<LevelSessionData>(LEVEL_SESSION);
        ...
        private TSaveData LoadingSaveData<TSaveData>(string saveDataKey)
        {
        ...
        private void SavingSaveData<TSaveData>(TSaveData saveData, string key)
        {
